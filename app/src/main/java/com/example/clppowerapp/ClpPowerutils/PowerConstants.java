...
//外网主入口url
    ...
    public static String ALLYUXING = MAINURL + "JiekouXianLuMingXi/WeiHuBanZu";
    //任务页面：运行单位
    public static String TASK_YUNXINGDANWEI = MAINURL + "JiekouXianLuMingXi/YunXingDanWei";
    //任务页面：维护班组
    public static String TASK_WEIHUBANZU= MAINURL + "JiekouXianLuMingXi/WeiHuBanZu";
    //任务页面：任务名称
    public static String TASK_RENWUMINGCHENG= MAINURL + "JiekouXianLuMingXi/RenWuMingCheng";
}
