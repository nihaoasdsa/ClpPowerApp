...
public interface NewNetInterface {
    ...
    void startGetRequest(Context context, String url, Map<String, String> map, final Boolean isShowLoading, NewCallBack<String> callBack);
    ...
    //正常get请求，回调不判断0000状态
    <T> void startGetRequestNoSuccess(Context context, Boolean isShowLoading, String url, Map<String, String> map, Class<T> tClass, NewCallBack<T> callBack);
