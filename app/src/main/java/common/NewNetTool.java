...
public class NewNetTool implements NewNetInterface {
    ...
    @Override
    public void startGetRequest(Context context, String url, Map<String,String> map, Boolean isShowLoading, NewCallBack<String> callBack) {
        mInterface.startGetRequest(context,url,map,isShowLoading,callBack);

    }

    @Override
    public <T> void startGetRequestNoSuccess(Context context, Boolean isShowLoading, String url, Map<String, String> map, Class<T> tClass, NewCallBack<T> callBack) {
        mInterface.startGetRequestNoSuccess(context,isShowLoading,url,map,tClass,callBack);
    }
